...
function buildOpenClawPrompt(input: {
  ...
  return [
    ...
    "For a direct request to play a named movie, return action play with payload {\"title\":\"...\"}.",
    "For a direct request to play a named episode, prefer payload {\"show\":\"...\",\"episodeTitle\":\"...\"}. Only rely on title alone when the user actually gave a single canonical episode title string.",
    "Example: if the user says 'play the Seinfeld episode The Contest', return action play with payload {\"show\":\"Seinfeld\",\"episodeTitle\":\"The Contest\"}.",
